//summon TNT in Minecraft, with specific motion patterns, and triggers the creation of a sphere of TNT with a specified radius upon a mouse click event.
...
function onMouseClick() {
    ...
    const radius = 5;  // Set your desired radial distance or radius
